...
def DEC_IDS_GCX():
    ...
    e = Dense(units=500, activation='relu', name='encode_0')(encode_inputs)
    e = Dense(units=500, activation='relu', name='encode_1')(e)
    e = Dense(units=2000, activation='relu', name='encode_2')(e)
    encode_outputs = Dense(units=10, activation='relu', name='encode_3')(e)
    decode_inputs = Dense(units=2000, activation='relu', name='decode_2')(encode_outputs)
    d = Dense(units=500, activation='relu', name='decode_1')(decode_inputs)
    d = Dense(units=500, activation='relu', name='decode_0')(d)
    decode_outputs = Dense(units=length, activation='relu', name='decode_out')(d)
...
class DEC(object):
    def __init__(self, dims, n_clusters=num_clusters, alpha=1.0):
        ...
        self.n_clusters = n_clusters
        self.alpha = alpha
        self.autoencoder, self.encoder = DEC_IDS_GCX()
            ...
            class PrintACC(callbacks.Callback):
                ...
                def on_epoch_end(self, epoch, logs=None):
                    ...
                    feature_model = Model(self.model.input,
                                          self.model.get_layer(name='encode_2').output)
