...
path = '/home/hbb/pythonProject/CNN_LSTM_AE_Unknow_Protocol_Classification/ISCX2012_1000_version_8class/'

class_list = ['bittorrent', 'dns', 'ftp', 'http', 'imap', 'pop3', 'smtp', 'ssh']
nb_classes = 8
length = 784
...
fig.savefig(result_path+'/pretraining_acc_8class.png')
fig1 = plt.figure()
...
fig1.savefig(result_path+'/pretraining_loss_8class.png')
...
def cluster_latent(latent, labels, n_classes=9):
    ...
    return ari, nmi
cluster_viz(encoded_img, test_y, save_dir, n_classes=8, fig_name='tsne_viz_8class.png')
test_x = test_x.reshape(test_x.shape[0], 784)
cluster_viz(test_x, test_y, save_dir, n_classes=9, fig_name='tsne_viz_8class_raw.png')

print('cluter the latent with k-means')
cluster_latent(encoded_img, test_y, n_classes=8)
